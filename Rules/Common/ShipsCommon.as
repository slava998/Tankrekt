shared class Ship
{
	...
	bool isStation;           //does the ship contain any station?
	bool isBootyStation;      //does the ship contain a booty station?
	bool isBuildStation;      //does the ship contain a usual station?
	...
	Ship()
	{
		...
		colliding = isMothership = isStation = isBootyStation = isBuildStation = isSecondaryCore = false;
		@centerBlock = null;
		id = soundsPlayed = 0;
		owner = "";
	}
